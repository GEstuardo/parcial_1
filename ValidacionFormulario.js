class Validation
{
   ...
   requireTextApellido(inputId, minLength, maxLength, illegalCharArray, necessaryCharArray)
   {
    ...
    /*
        Direccion
    */
   requireTextDireccion(inputId, minLength, maxLength, illegalCharArray, necessaryCharArray)
   {
       let input = $("#" + inputId);
       let invalidString = "";
 ...
 /*
        Usuario
    */
   requireTextUser(inputId, minLength, maxLength, illegalCharArray, necessaryCharArray)
   {
       let input = $("#" + inputId);
       let invalidString = "";
